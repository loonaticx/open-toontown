...
class MinigameAvatarScorePanel(DirectFrame):
    ...
    def __init__(self, avId, avName):
        ...
        if self.avId in base.cr.doId2do:
            ...
            self.avatar = None
        DirectFrame.__init__(self, relief = None, image_color = GlobalDialogColor, image_scale = (0.4, 1.0, 0.24),
                             image_pos = (0.0, 0.1, 0.0))
        self['image'] = DGG.getDefaultDialogGeom()
        self.scoreText = DirectLabel(self, relief = None, text = '0', text_scale = TTLocalizer.MASPscoreText,
                                     pos = (0.1, 0.0, -0.09))
        if self.avatar:
            ...
            self.laffMeter = None
        self.nameText = DirectLabel(self, relief = None, text = avName, text_scale = TTLocalizer.MASPnameText,
                                    text_pos = (0.0, 0.06), text_wordwrap = 7.5, text_shadow = (1, 1, 1, 1))
        self.show()
        return
