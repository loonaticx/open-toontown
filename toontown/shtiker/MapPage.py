...
class MapPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.map = DirectFrame(parent = self, relief = None, image = mapModel.find('**/toontown_map'),
    ...
    def enter(self):
        ...
        if base.cr.playGame.getPlaceId() == ToontownGlobals.MyEstate and base.cr.playGame.hood.loader.atMyEstate() or\
                self.book.safeMode:
            self.goHomeButton.hide()
