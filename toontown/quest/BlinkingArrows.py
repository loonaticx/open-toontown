...
class BlinkingArrows:
    ...
    def startArrowsFlashing(self):
        ...
        if self.otherNode:
            self.otherNode.show()
            self.arrowTrack = Sequence(Parallel(self.arrow1.colorScaleInterval(self.onTime, onColor, offColor),
                                       ...
                                       Parallel(self.arrow1.colorScaleInterval(self.offTime, offColor, onColor),
