...
class CatalogItemPanel(DirectFrame):
    ...
    def __init__(self, parent = aspect2d, parentCatalogScreen = None, **kw):
        optiondefs = (
        ('item', None, DGG.INITOPT), ('type', CatalogItem.CatalogTypeUnspecified, DGG.INITOPT), ('relief', None, None))
    ...
    def load(self):
        ...
        if self['item'].needsCustomize() and (
                typeCode == CatalogItemTypes.WALLPAPER_ITEM or typeCode == CatalogItemTypes.FLOORING_ITEM or typeCode
                == CatalogItemTypes.MOULDING_ITEM or typeCode == CatalogItemTypes.FURNITURE_ITEM or typeCode ==
                CatalogItemTypes.WAINSCOTING_ITEM or typeCode == CatalogItemTypes.TOON_STATUE_ITEM):
            ...
            if self.numItems > 1:
                ...
                self.nextVariant = DirectButton(parent = self, relief = None, image = (nextUp,
                                                                                       ...
                                                                                       nextRollover,
                                                                                       nextUp),
                                                image3_color = (1, 1, 1, 0.4), pos = (0.13, 0, 0),
                ...
                self.prevVariant = DirectButton(parent = self, relief = None, image = (prevUp,
                                                                                       ...
                                                                                       prevUp),
                                                image3_color = (1, 1, 1, 0.4), pos = (-0.13, 0, 0),
                                                command = self.showPrevVariant, state = DGG.DISABLED)
        ...
        self.typeLabel = DirectLabel(parent = self, relief = None, pos = (0, 0, 0.24), scale = TTLocalizer.CIPtypeLabel,
                                     text = self['item'].getTypeName(), text_fg = (0.95, 0.95, 0, 1),
        ...
        self.nameLabel = DirectLabel(parent = self, relief = None, text = self['item'].getDisplayName(),
        ...
        if self['item'].isSaleItem():
            ...
            priceScale = 0.06
        self.priceLabel = DirectLabel(parent = self, relief = None, pos = (0, 0, -0.3), scale = priceScale,
                                      text = priceStr, text_fg = (0.95, 0.95, 0, 1), text_shadow = (0, 0, 0, 1),
                                      text_font = ToontownGlobals.getSignFont(), text_align = TextNode.ACenter)
        ...
        self.buyButton = DirectButton(parent = self, relief = None, pos = (0.2, 0, 0.15), scale = (0.7, 1, 0.8),
                                      text = buyText, text_scale = buyTextScale, text_pos = (-0.005, -0.01),
                                      image = (upButton,
                                               downButton,
                                               rolloverButton,
                                               upButton), image_color = (1.0, 0.2, 0.2, 1),
                                      image0_color = Vec4(1.0, 0.4, 0.4, 1), image3_color = Vec4(1.0, 0.4, 0.4, 0.4),
        ...
        self.soundOnButton = DirectButton(parent = self, relief = None, pos = (0.2, 0, -0.15), scale = (0.7, 1, 0.8),
                                          text_scale = buyTextScale, text_pos = (-0.005, -0.01), image = (upButton,
                                                                                                          downButton,
                                                                                                          rolloverButton,
                                                                                                          upButton),
                                          image_color = (0.2, 0.5, 0.2, 1), image0_color = Vec4(0.4, 0.5, 0.4, 1),
                                          image3_color = Vec4(0.4, 0.5, 0.4, 0.4), command = self.handleSoundOnButton)
        self.soundOnButton.hide()
        soundOn.setScale(0.1)
        soundOn.reparentTo(self.soundOnButton)
        self.soundOffButton = DirectButton(parent = self, relief = None, pos = (0.2, 0, -0.15), scale = (0.7, 1, 0.8),
                                           text_scale = buyTextScale, text_pos = (-0.005, -0.01), image = (upButton,
                                                                                                           downButton,
                                                                                                           rolloverButton,
                                                                                                           upButton),
                                           image_color = (0.2, 1.0, 0.2, 1), image0_color = Vec4(0.4, 1.0, 0.4, 1),
                                           image3_color = Vec4(0.4, 1.0, 0.4, 0.4), command = self.handleSoundOffButton)
        ...
        self.giftButton = DirectButton(parent = self, relief = None, pos = (0.2, 0, 0.15), scale = (0.7, 1, 0.8),
                                       text = TTLocalizer.CatalogGiftText, text_scale = buyTextScale,
                                       text_pos = (-0.005, -0.01), image = (upButton,
                                                                            downButton,
                                                                            rolloverButton,
                                                                            upButton), image_color = (1.0, 0.2, 0.2, 1),
                                       image0_color = Vec4(1.0, 0.4, 0.4, 1), image3_color = Vec4(1.0, 0.4, 0.4, 0.4),
    ...
    def createEmblemPrices(self, numericBeanPrice):
        ...
        if emblemPrices:
            if numericBeanPrice:
                ...
                self.beanPriceLabel = DirectLabel(parent = self, relief = None, pos = (0, 0, -0.3), scale = priceScale,
                                                  image = beanModel, image_pos = (-0.4, 0, 0.4),
                                                  text = str(numericBeanPrice), text_fg = (0.95, 0.95, 0, 1),
            ...
            if ToontownGlobals.EmblemTypes.Silver < len(emblemPrices):
                ...
                if silverPrice:
                    self.silverPriceLabel = DirectLabel(parent = self, relief = None, pos = (0, 0, -0.3),
                                                        scale = priceScale, image = silverModel,
                                                        image_pos = (-0.4, 0, 0.4), text = str(silverPrice),
            ...
            if ToontownGlobals.EmblemTypes.Gold < len(emblemPrices):
                ...
                if goldPrice:
                    self.goldPriceLabel = DirectLabel(parent = self, relief = None, pos = (0, 0, -0.3),
                                                      scale = priceScale, image = goldModel, image_pos = (-0.4, 0, 0.4),
                                                      text = str(goldPrice), text_fg = (0.95, 0.95, 0, 1),
                                                      text_shadow = (0, 0, 0, 1),
                                                      text_font = ToontownGlobals.getSignFont(),
                                                      text_align = TextNode.ALeft)
            numPrices = 0
    ...
    def updateBuyButton(self):
        ...
        if isNameTag and not localAvatar.getGameAccess() == OTPGlobals.AccessFull:
            ...
            self.buyButton['state'] = DGG.DISABLED
        elif self['item'].getEmblemPrices() and not base.localAvatar.isEnoughMoneyAndEmblemsToBuy(
    ...
    def __handleGiftRequest(self):
        ...
        self.verify = TTDialog.TTGlobalDialog(doneEvent = 'verifyGiftDone', message = message,
            ...
            if self['item'].isGift() <= 0:
                ...
                if self['item'].forBoysOnly() and avatar.getStyle().getGender() == 'f' or self[
                    ...
                    return
                        ...
                        self['type']) <= base.localAvatar.getMoney() + base.localAvatar.getBankMoney():
