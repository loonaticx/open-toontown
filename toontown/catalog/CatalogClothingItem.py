...
class CatalogClothingItem(CatalogItem.CatalogItem):
    ...
    def reachedPurchaseLimit(self, avatar):
        ...
        if self.isShirt():
            ...
            if dna.topTex == defn[0] and dna.topTexColor == defn[2][self.colorIndex][0] and dna.sleeveTex == defn[
                1] and dna.sleeveTexColor == defn[2][self.colorIndex][1]:
                return 1
            l = avatar.clothesTopsList
            for i in range(0, len(l), 4):
                if l[i] == defn[0] and l[i + 1] == defn[2][self.colorIndex][0] and l[i + 2] == defn[1] and l[i + 3] == \
                        defn[2][self.colorIndex][1]:
                    return 1
    ...
    def requestPurchase(self, phone, callback):
        ...
        if avatar.isClosetFull(clothesOnOrder):
            ...
            self.dialog = TTDialog.TTDialog(style = TTDialog.YesNo, text = TTLocalizer.CatalogPurchaseClosetFull,
