...
class TownBattleSOSPetInfoPanel(StateData.StateData):
    ...
    def load(self):
        ...
        self.feedButton = DirectButton(parent = self.frame, image = (gui.find('**/ButtonFeedUp'),
                                       ...
                                       geom = gui.find('**/PetControlFeedIcon'), image3_color = disabledImageColor,
                                       relief = None, text = TTLocalizer.PetPanelFeed, text_scale = 0.5,
        ...
        self.callButton = DirectButton(parent = self.frame, image = (gui.find('**/ButtonGoToUp'),
                                       ...
                                       geom = gui.find('**/PetControlGoToIcon'), image3_color = disabledImageColor,
                                       relief = None, text = TTLocalizer.PetPanelCall, text0_fg = text0Color,
                                       text1_fg = text1Color, text2_fg = text2Color, text3_fg = text3Color,
                                       text_scale = 0.5, text_pos = (-0.5, 1.3), text_align = TextNode.ALeft)
        ...
        self.scratchButton = DirectButton(parent = self.frame, image = (gui.find('**/ButtonScratchUp'),
                                          ...
                                          text1_fg = text1Color, text2_fg = text2Color, text3_fg = text3Color,
                                          text_scale = 0.5, text_pos = (-0.5, 2.05), text_align = TextNode.ALeft)
        self.scratchButton['state'] = DGG.DISABLED
        self.callOwnerButton = DirectButton(parent = self.frame, image = (
        ...
        gui.find('**/PetControlToonButtonRollover')), geom = gui.find('**/PetControlToonIcon'),
                                            ...
                                            image3_color = disabledImageColor, text = ('',
                                                                                       ...
                                                                                       TTLocalizer.PetPanelOwner,
                                                                                       ''), text_fg = text2Color,
                                            text_shadow = (0, 0, 0, 1), text_scale = 0.35, text_pos = (0.3, 1.1),
                                            text_align = TextNode.ACenter, command = self.__handleDetail)
        self.callOwnerButton['state'] = DGG.DISABLED
        self.detailButton = DirectButton(parent = self.frame, image = (
        gui.find('**/PetControlToonButtonUp1'), gui.find('**/PetControlToonButtonDown1'),
        gui.find('**/PetControlToonButtonRollover1')), geom = gui.find('**/PetBattleIcon'),
                                         geom3_color = disabledImageColor, relief = None, pos = (0, 0, 0),
                                         image3_color = disabledImageColor, text = ('',
    ...
    def __handleDetail(self):
        self.petDetailPanel = PetDetailPanel.PetDetailPanel(pet = self.petProxy,
    ...
    def __fillPetInfo(self, avatar):
        ...
        if self.nameLabel == None:
            ...
            self.stateLabel = DirectLabel(parent = self.frame, pos = (0.7, 0, 3.5), relief = None, text = '',
                                          text_font = avatar.getFont(), text_fg = Vec4(0, 0, 0, 1), text_scale = 0.4,
                                          text_wordwrap = 7.5, text_shadow = (1, 1, 1, 1))
