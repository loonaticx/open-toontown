...
class GolfRewardDialog:
    ...
    def __init__(self, avIdList, trophyList, rankingsList, holeBestList, courseBestList, cupList, localAvId,
                 tieBreakWinner, aimTimesList, endMovieCallback = None):
    ...
    def createRewardMovie(self, localAvId):
        ...
        def setTrophyLabelText(text, playerIndex, trophyIndex):
            ...
            self.trophy = GolfTrophy(level = self.trophyList[playerIndex][trophyIndex], parent = self.trophyLabel,
                                     pos = (1.3, 0, -0.25))
        ...
        for avId in self.avIdList:
            if avId != localAvId:
                ...
                for rewardText in rewardTextList:
                    ...
                    oneTrophyIval = Parallel(Func(setTrophyLabelText, rewardText, playerIndex, trophyIndex),
                                             LerpColorScaleInterval(self.trophyLabel, 4, Vec4(1, 1, 1, 0),
        ...
        for rewardText in rewardTextList:
            if len(rewardTextList) > 0:
                var = (rewardText, playerIndex, trophyIndex)
                oneRewardIval = Parallel(Func(setTrophyLabelText, rewardText, playerIndex, trophyIndex),
                                         LerpColorScaleInterval(self.trophyLabel, 4, Vec4(1, 1, 1, 0),
                                                                startColorScale = Vec4(1, 1, 1, 1),
                                                                blendType = 'easeIn'))
        ...
        if len(rewardCupList) > 0:
            for rewardText in rewardCupList:
                oneCupIval = Parallel(Func(setRewardLabelText, rewardText),
                                      LerpColorScaleInterval(self.rewardLabel, 4, Vec4(1, 1, 1, 0),
                                                             startColorScale = Vec4(1, 1, 1, 1), blendType = 'noBlend'))
        ...
        if self.tieBreakWinner:
            ...
            if av:
                ...
                randomWinnerIval = Parallel(Func(setRewardLabelText, rewardText),
                                            LerpColorScaleInterval(self.rewardLabel, 7, Vec4(1, 1, 1, 0),
                                                                   startColorScale = Vec4(1, 1, 1, 1),
                                                                   blendType = 'noBlend'))
        ...
        oneRankIval = Parallel(Func(setRankLabelText, rankText),
                               LerpColorScaleInterval(self.rankLabel, 8, Vec4(1, 1, 1, 1),
        ...
        if len(rewardHoleList) > 0:
            for rewardText in rewardHoleList:
                oneHoleIval = Parallel(Func(setRewardLabelText, rewardText),
                                       LerpColorScaleInterval(self.rewardLabel, 8, Vec4(1, 1, 1, 0),
                                                              startColorScale = Vec4(1, 1, 1, 1), blendType = 'easeIn'))
        ...
        if len(rewardCourseList) > 0:
            for rewardText in rewardCourseList:
                oneCourseIval = Parallel(Func(setRewardLabelText, rewardText),
                                         LerpColorScaleInterval(self.rewardLabel, 4, Vec4(1, 1, 1, 0),
                                                                startColorScale = Vec4(1, 1, 1, 1),
                                                                blendType = 'easeIn'))
    ...
    def setup(self, localAvId):
        self.rewardBoard = DirectFrame(parent = aspect2d, relief = None, geom = DGG.getDefaultDialogGeom(),
                                       geom_color = ToontownGlobals.GlobalDialogColor, geom_scale = (1.75, 1, 0.6),
                                       pos = (0, 0, -0.6))
        self.rewardLabel = DirectLabel(parent = self.rewardBoard, relief = None, pos = (-0, 0, 0),
                                       text_align = TextNode.ACenter, text = '', text_scale = 0.05, text_wordwrap = 30)
        self.rankLabel = DirectLabel(parent = self.rewardBoard, relief = None, pos = (-0, 0, 0.17),
                                     text_align = TextNode.ACenter, text = '', text_scale = 0.06)
        self.trophyLabel = DirectLabel(parent = self.rewardBoard, relief = None, pos = (-0.7, 0, 0.05),
                                       text_align = TextNode.ALeft, text = '', text_scale = 0.06, text_wordwrap = 20)
