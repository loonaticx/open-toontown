...
AI.GameActions = IntEnum('AI.GameActions', (
 'LandOnWinPlatform', 'WinStateFinished', 'GotoWinState', 'HitWhirlwind', 'HitLegalEagle', 'HitMinion', 'DebuffInvul',
 'RequestEnterEagleInterest', 'RequestExitEagleInterest', 'RanOutOfTimePenalty', 'Died', 'Spawn', 'SetBlades',
 'BladeLost'
))
...
Gameplay.FuelStates = IntEnum('Gameplay.FuelStates',('FuelNoPropeller', 'FuelEmpty', 'FuelVeryLow', 'FuelLow', 'FuelNormal'))
...
Gameplay.BackpackStates = IntEnum('Gameplay.BackpackState',('Normal', 'Targeted', 'Attacked', 'Refuel'))
...
Level.GatherableTypes = IntEnum('Level.GatherableTypes',('Memo', 'Propeller', 'LaffPowerup', 'InvulPowerup'))
Level.ObstacleTypes = IntEnum('Level.ObstacleTypes',('Whirlwind', 'Fan', 'Minion'))
Level.PlatformTypes = IntEnum('Level.PlatformTypes',('Platform', 'StartPlatform', 'EndPlatform'))
