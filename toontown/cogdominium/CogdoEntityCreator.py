...
class CogdoEntityCreator(EntityCreator.EntityCreator):
    ...
    def __init__(self, level):
        ...
        self.privRegisterTypes({
                                   ...
                                   'cogdoBoardroomGameSettings': Functor(self._createCogdoSettings,
                                                                         CogdoBoardroomGameConsts.Settings),
                                   'cogdoCraneGameSettings': Functor(self._createCogdoSettings,
                                                                     CogdoCraneGameConsts.Settings),
                                   'cogdoCraneCogSettings': Functor(self._createCogdoSettings,
