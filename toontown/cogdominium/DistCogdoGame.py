...
class DistCogdoGame(DistCogdoGameBase, DistributedObject):
    ...
    def __init__(self, cr):
        ...
        base.cogdoGame = self
        self._waitingStartLabel = DirectLabel(text = TTL.MinigameWaitingForOtherPlayers, text_fg = VBase4(1, 1, 1, 1),
        ...
        self.loadFSM = ClassicFSM.ClassicFSM('DistCogdoGame.loaded', [
            ...
            State.State('Loaded', self.enterLoaded, self.exitLoaded, ['NotLoaded'])], 'NotLoaded', 'NotLoaded')
        ...
        self._stashElevatorFC = FunctionCall(self._doStashElevator, self._toonsInEntranceElev, self._gotInterior,
    ...
    def enterIntro(self, duration = MinigameGlobals.rulesDuration):
        ...
        self._rulesPanel = CogdoGameRulesPanel('CogdoGameRulesPanel', self.getTitle(), '', self._rulesDoneEvent,
                                               timeout = duration)
