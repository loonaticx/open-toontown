...
class ShuffleButton:
    ...
    def load(self):
        ...
        self.parentFrame = DirectFrame(parent = self.parent.parentFrame, relief = DGG.RAISED, pos = (0, 0, -1),
                                       frameColor = (1, 0, 0, 0))
        self.shuffleFrame = DirectFrame(parent = self.parentFrame, image = shuffleFrame,
                                        image_scale = halfButtonInvertScale, relief = None, frameColor = (1, 1, 1, 1))
        self.shuffleFrame.hide()
        self.shuffleBtn = DirectButton(parent = self.parentFrame, relief = None,
                                       image = (shuffleUp, shuffleDown, shuffleUp), image_scale = halfButtonInvertScale,
                                       image1_scale = (-0.63, 0.6, 0.6), image2_scale = (-0.63, 0.6, 0.6),
                                       text = (TTLocalizer.ShuffleButton,
                                               TTLocalizer.ShuffleButton,
                                               TTLocalizer.ShuffleButton,
                                               ''), text_font = ToontownGlobals.getInterfaceFont(),
                                       text_scale = TTLocalizer.SBshuffleBtn, text_pos = (0, -0.02),
                                       text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1), command = self.chooseRandom)
        self.incBtn = DirectButton(parent = self.parentFrame, relief = None, image = (shuffleArrowUp,
                                   ...
                                   image2_scale = halfButtonInvertHoverScale, pos = (0.202, 0, 0),
        ...
        self.decBtn = DirectButton(parent = self.parentFrame, relief = None, image = (shuffleArrowUp,
                                   ...
                                   image2_scale = halfButtonHoverScale, pos = (-0.202, 0, 0),
    ...
    def startShowLerp(self):
        self.showLerp = Sequence(Parallel(Func(self.shuffleFrame.show), Func(self.incBtn.show), Func(self.decBtn.show)),
