...
class ClothesGUI(StateData.StateData):
    ...
    def load(self):
        ...
        self.shirtFrame = DirectFrame(parent = self.parentFrame, image = shuffleFrame,
                                      image_scale = halfButtonInvertScale, relief = None, pos = (0, 0, -0.4),
                                      hpr = (0, 0, 3), scale = 1.2, frameColor = (1, 1, 1, 1),
                                      text = TTLocalizer.ClothesShopShirt, text_scale = 0.0575,
        ...
        self.topLButton = DirectButton(parent = self.shirtFrame, relief = None, image = (shuffleArrowUp,
                                       ...
                                       image2_scale = halfButtonHoverScale, pos = (-0.2, 0, 0), command = self.swapTop,
                                       extraArgs = [-1])
        ...
        self.bottomFrame = DirectFrame(parent = self.parentFrame, image = shuffleFrame,
                                       image_scale = halfButtonInvertScale, relief = None, pos = (0, 0, -0.65),
                                       hpr = (0, 0, -2), scale = 1.2, frameColor = (1, 1, 1, 1),
                                       text = TTLocalizer.ColorShopToon, text_scale = 0.0575,
                                       text_pos = (-0.001, -0.015), text_fg = (1, 1, 1, 1))
