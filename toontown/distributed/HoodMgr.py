...
class HoodMgr(DirectObject.DirectObject):
    ...
    ToontownCentralTunnelDropPoints = ([-28.3,
                                       ...
                                       [30.488,
                                        ...
                                        0])
    dropPoints = {
        ToontownGlobals.DonaldsDock: ([-28.0,
                                       -2.5,
                                       5.8,
                                       120.0,
                                       0.0,
    ...
    def getAvailableZones(self):
        if base.launcher == None:
            return self.getZonesInPhase(4) + self.getZonesInPhase(6) + self.getZonesInPhase(8) + self.getZonesInPhase(
                9) + self.getZonesInPhase(10) + self.getZonesInPhase(11) + self.getZonesInPhase(
                12) + self.getZonesInPhase(13)
        else:
            zones = []
        ...
        for i in nodeList:
            ...
            for p in range(linkTunnelNPC.getNumPaths()):
                ...
                hoodPart.accept('enter' + linkSphere.getName(), hoodPart.handleEnterTunnel, [{
                                                                                                 'loader': ZoneUtil.getLoaderName(
                                                                                                     zoneId),
                                                                                                 'where': ZoneUtil.getToonWhereName(
                                                                                                     zoneId),
                                                                                                 'how': how,
                                                                                                 'hoodId': hoodId,
                                                                                                 'zoneId': zoneId,
