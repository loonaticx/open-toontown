...
class TTChatInputWhiteList(ChatInputWhiteListFrame):
    ...
    def __init__(self, parent = None, **kw):
        ...
        self.chatFrame = DirectFrame(parent = self, image = gui.find('**/Chat_Bx_FNL'), relief = None,
                                     pos = (0.0, 0, 0.0), state = DGG.NORMAL)
        ...
        gui.find('**/ChtBx_ChtBtn_UP'), gui.find('**/ChtBx_ChtBtn_DN'), gui.find('**/ChtBx_ChtBtn_RLVR')),
            ...
            '', OTPLocalizer.ChatInputNormalSayIt, OTPLocalizer.ChatInputNormalSayIt), text_scale = 0.06,
        ...
        if len(text) > 0 and text[0] in prefixes:
            ...
            if not strict:
                ...
                if lastword == '' or self.whiteList.isPrefix(
                        lastword.encode('utf-8')) or not base.cr.whiteListChatEnabled:
                    newwords[-1] = lastword
                elif flag:
