...
class PartyPlanner(DirectFrame, FSM):
    ...
    def __init__(self, doneEvent = None):
        ...
        self.cleanPartyTime = self.partyTime + timedelta(minutes = minutesToNextFifteen,
                                                         seconds = -self.partyTime.second)
    ...
    def _createTimePage(self):
        ...
        self.timePageToontownLabel = DirectLabel(parent = page, relief = None,
                                                 text = TTLocalizer.PartyPlannerTimeToontown,
                                                 pos = self.gui.find('**/step_03_toontown_locator').getPos(),
                                                 scale = 0.15, text_fg = (1.0, 0.0, 0.0, 1.0),
        ...
        self.timePageRecapToontownTimeLabel1 = DirectLabel(parent = page, relief = None,
                                                           ...
                                                           pos = self.gui.find(
                                                               '**/step_03_toontownTime_locator').getPos(),
                                                           scale = 0.06)
    ...
    def _createGuestPage(self):
        ...
        self.publicPrivateLabel = DirectLabel(parent = page, relief = None,
        ...
        self.publicButton = DirectButton(parent = page, relief = None, geom = (self.gui.find('**/publicButton_up'),
                                                                               ...
                                                                               self.gui.find(
                                                                                   '**/publicButton_rollover'),
                                                                               self.gui.find(
                                                                                   '**/publicButton_inactive')),
        ...
        self.privateButton = DirectButton(parent = page, relief = None, geom = (self.gui.find('**/privateButton_up'),
                                                                                ...
                                                                                self.gui.find(
                                                                                    '**/privateButton_rollover'),
                                                                                self.gui.find(
                                                                                    '**/privateButton_inactive')),
    ...
    def _createPartyEditorPage(self):
        ...
        self.beanBank = DirectLabel(parent = page, relief = None, text = str(self.totalMoney),
                                    text_align = TextNode.ARight, text_scale = 0.075, text_fg = (0.95, 0.95, 0, 1),
                                    text_shadow = (0, 0, 0, 1), text_pos = (0.495, -0.53),
                                    text_font = ToontownGlobals.getSignFont(), textMayChange = True,
                                    image = catalogGui.find('**/bean_bank'), image_scale = (0.65, 0.65, 0.65),
                                    scale = 0.9, pos = (-0.75, 0.0, 0.6))
    ...
    def _createInvitationPage(self):
        ...
        self.invitationTitleLabel = DirectLabel(parent = page, relief = None,
                                                text = TTLocalizer.PartyPlannerConfirmTitle, textMayChange = True,
                                                pos = self.gui.find('**/title_locator').getPos(),
                                                scale = self.titleScale)
        self.invitationBackground = DirectFrame(parent = page, relief = None,
        ...
        self.gui.find('**/send_up'), self.gui.find('**/send_down'), self.gui.find('**/send_rollover')),
                                         text = TTLocalizer.PartyPlannerInviteButton, textMayChange = True,
                                         text_scale = 0.05, text_pos = (pos[0], pos[2]),
    ...
    def __handleHolidays(self):
        ...
        if hasattr(base.cr, 'newsManager') and base.cr.newsManager:
            ...
            if ToontownGlobals.WINTER_DECORATIONS not in holidayIds and ToontownGlobals.WACKY_WINTER_DECORATIONS not \
                    in holidayIds:
