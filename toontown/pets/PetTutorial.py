...
class PetTutorial(DirectFrame, FSM.FSM):
    ...
    def __init__(self, doneEvent):
        ...
        self.title = DirectLabel(self, relief = None, text = '', text_pos = (0.0, 0.32), text_fg = (1, 0, 0, 1),
                                 text_scale = TTLocalizer.PTtitle, text_font = ToontownGlobals.getSignFont())
        images = loader.loadModel('phase_5.5/models/gui/PetTutorial')
        self.iPage1 = DirectFrame(self, image = images.find('**/PetTutorialPanel'), scale = 0.75,
                                  pos = (-0.55, -0.1, 0))
        self.iPage1.hide()
        self.iPage2 = DirectFrame(self, image = images.find('**/PetTutorialSpeedChat'), scale = 0.75,
                                  pos = (0.43, -0.1, 0.05))
        self.iPage2.hide()
        self.iPage3 = DirectFrame(self, image = images.find('**/PetTutorialCattlelog'), scale = 0.75,
                                  pos = (-0.55, -0.1, 0))
        self.iPage3.hide()
        ...
        self.bNext = DirectButton(self, image = (gui.find('**/Horiz_Arrow_UP'),
                                  ...
                                  relief = None, text = TTLocalizer.PetTutorialNext, text3_fg = Vec4(0, 0, 0, 0.5),
        ...
        self.bPrev = DirectButton(self, image = (gui.find('**/Horiz_Arrow_UP'),
                                                 ...
                                                 gui.find('**/Horiz_Arrow_Rllvr'),
                                                 gui.find('**/Horiz_Arrow_UP')), image3_color = Vec4(1, 1, 1, 0.5),
                                  image_scale = (-1.0, 1.0, 1.0), relief = None, text = TTLocalizer.PetTutorialPrev,
