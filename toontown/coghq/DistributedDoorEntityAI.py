...
class DistributedDoorEntityAI(DistributedDoorEntityBase.DistributedDoorEntityBase,
    ...
    def getLocksState(self):
        ...
        if hasattr(self, 'locks'):
            stateBits = self.locks[0].getLockState() & 15 | self.locks[1].getLockState() << 4 & 240 | self.locks[
                2].getLockState() << 8 & 3840
        return stateBits
    ...
    def setup(self):
        ...
        self.locks = [Lock(self, 0, self.unlock0Event, self.isLock0Unlocked),
