...
class DistributedCashbotBossTreasure(DistributedSZTreasure.DistributedSZTreasure):
    ...
    def setFinalPosition(self, x, y, z):
        ...
        lerpTime = 1
        self.treasureFlyTrack = Sequence(Func(self.collNodePath.stash), Parallel(
            ProjectileInterval(self.treasure, startPos = Point3(0, 0, 0), endPos = Point3(0, 0, 0), duration = lerpTime,
                               gravityMult = 2.0),
