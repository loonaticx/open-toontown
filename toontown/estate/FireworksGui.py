...
class FireworksGui(DirectFrame):
    ...
    def __init__(self, doneEvent, shootEvent):
        DirectFrame.__init__(self, relief = None, geom = DGG.getDefaultDialogGeom(), geom_color = (0, 0.5, 1, 1),
                             geom_scale = (0.43, 1, 1.4), pos = (1.1, 0, 0))
    ...
    def load(self):
        ...
        self.panelPicker = DirectScrolledList(parent = self, items = itemStrings, command = self.scrollItem,
                                              ...
                                              incButton_relief = None, incButton_scale = (0.5, 1, -1),
                                              ...
                                              decButton_image = (gui.find('**/FndsLst_ScrollUp'),
                                                                 ...
                                                                 gui.find('**/FndsLst_ScrollUp_Rllvr'),
                                                                 gui.find('**/FndsLst_ScrollUp')),
                                              decButton_relief = None, decButton_scale = (0.5, 1, 1),
                                              decButton_pos = (0, 0, 0.2), decButton_image3_color = Vec4(1, 1, 1, 0.3))
        ...
        self.cancelButton = DirectButton(parent = self, relief = None, image = cancelImageList, pos = (0.15, 0, -0.62),
                                         text_scale = 0.06, text_pos = (0, -0.1), command = self.__cancel)
        buttons.removeNode()
        ...
        for i in list(Fireworks.colors.keys()):
            ...
            height = 0.07
            paddedHeight = 0.1
            buttonBg = DirectFrame(self, geom = DGG.getDefaultDialogGeom(), geom_scale = paddedHeight,
                                   geom_color = self.bgColor, pos = (0.15, 0, 0.5 - (paddedHeight + 0.025) * i),
                                   relief = None)
            self.initialiseoptions(buttonBg)
            button = DirectButton(buttonBg, image = (
            DGG.getDefaultDialogGeom(), DGG.getDefaultDialogGeom(), DGG.getDefaultDialogGeom()), relief = None,
                                  command = self.__handleColor, extraArgs = [i])
