...
class FlowerSellGUI(DirectFrame):
    ...
    def __init__(self, doneEvent):
        DirectFrame.__init__(self, relief = None, state = 'normal', geom = DGG.getDefaultDialogGeom(),
                             ...
                             text_scale = TTLocalizer.FSGUIdirectFrame, text_pos = (0, 0.65))
        ...
        self.cancelButton = DirectButton(parent = self, relief = None, image = cancelImageList, pos = (0.3, 0, -0.58),
                                         text = TTLocalizer.FlowerGuiCancel, text_scale = TTLocalizer.FSGUIcancelButton,
                                         text_pos = (0, -0.1), command = self.__cancel)
        self.okButton = DirectButton(parent = self, relief = None, image = okImageList, pos = (0.6, 0, -0.58),
                                     text = TTLocalizer.FlowerGuiOk, text_scale = TTLocalizer.FSGUIokButton,
                                     text_pos = (0, -0.1), command = self.__sellFlower)
        buttons.removeNode()
